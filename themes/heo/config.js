const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: '欢迎到阿珍福利网', url: 'https://www.azfuli.pro/' },
    { title: '来这里分享你的福利', url: 'https://www.azfuli.pro/' }
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '免费分享',
  HERO_TITLE_2: '互联网开源精神',
  HERO_TITLE_3: 'azfuli.pro',
  HERO_TITLE_4: '强势上线',
  HERO_TITLE_5: '阿珍福利网',
  HERO_TITLE_LINK: 'https://azfuli.pro',
  ...
  INFO_CARD_URL: 'https://www.azfuli.pro/', // 个人资料底部按钮链接
  ...
  SOCIAL_CARD_TITLE_1: 'TG交流群',
  SOCIAL_CARD_TITLE_2: '加入我们的社群讨论分享',
  SOCIAL_CARD_TITLE_3: '点击加入社群',
  SOCIAL_CARD_URL: 'https://t.me/azfuli',
